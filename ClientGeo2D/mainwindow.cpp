    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->listeObjets->addItem("Cercle");
    ui->listeObjets->addItem("Quadrilatère");
    ui->listeObjets->addItem("Polygone");
    ui->listeObjets->addItem("Triangle");
...
{
    QString s = ui->listeObjets->currentText();
    if(s == "Segment")
    {
