...
ConstructeurRectangle::ConstructeurRectangle(ConstructeurCOR *s) : ConstructeurCOR(s)
{

}

Figure* ConstructeurRectangle::resoudre1(const QDomNode *d) const
{
    QDomElement objet = d->toElement();
    if(objet.tagName() == "rectangle")
    {
        ...
        Rectangle *t = new Rectangle(new Point(x1,y1), new Point(x2,y2), new Point(x3,y3), new Point(x4,y4), Couleur::getNameCouleur(couleur));
        return t;
    }
    else
    {
